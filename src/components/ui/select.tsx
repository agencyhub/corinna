...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-11 w-full items-center justify-between rounded-lg border border-input bg-background px-4 py-2.5 text-sm ring-offset-background transition-all duration-200 placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:border-orange-500 hover:border-gray-400 disabled:cursor-not-allowed disabled:opacity-50 shadow-soft focus:shadow-medium [&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
